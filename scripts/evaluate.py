...
# @click.option('--batch-size', default=dataloader_params.batch_size, type=int, help='Batch size for evaluation')
...
def evaluate(checkpoint_path, 
    ...
    datamodule = DataModule(data_dir=prot_cnn_loaded.hparams.data_dir,
                            batch_size=prot_cnn_loaded.hparams.batch_size,
                            max_len=prot_cnn_loaded.hparams.max_len,
                            shuffle=prot_cnn_loaded.hparams.shuffle,
                            num_workers=prot_cnn_loaded.hparams.num_workers,
                            pin_memory=prot_cnn_loaded.hparams.pin_memory)
